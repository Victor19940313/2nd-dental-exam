  ...
  var TOURS = {
    ...
    examHome: {
      ...
      steps: [
        ...
        },
        {
          s: "#btn-resume",
          t: "回到考題",
          b: "不管你跑去筆記本、口訣區還是關掉網頁，按這裡就回到上次寫到的那一題，接著寫。",
        },        {
          s: "#btn-browse",
          t: "瀏覽：用關鍵字找題目",
    ...
    examBrowse: {
      ...
      steps: [
        ...
        { s: "#bf-row", t: "照標記、科目篩", b: "只看某一科、或只看你標了「再努力」「送他吧」的題目，點一下就篩。" },
    ...
    mnemonics: {
      ...
      steps: [
        ...
        { s: "#history-btn", t: "📜 歷史", b: "每個章節的所有版本都在這裡，可以預覽、還原到任何一版。" },
        {
          s: "#pub-toggle",
          t: "公開分享",
          b: "想分享給大家就打開它。一定要先選考點，複製別人的章節不能再公開。公開後別人可以按讚、收藏、留言。",
        },
