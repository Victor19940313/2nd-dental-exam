const CACHE_NAME = 'dental-all-v5';
const PRECACHE = [
  '/',
  '/index.html',
  '/ya3/',
  ...
  '/exam/image-review.html',
  '/exam/comparison-tables.json',
  '/exam/number-reference.json',
  '/exam/flashcards.json',
  '/exam/cross-links.json',
  '/exam/similar-questions.json',
];
