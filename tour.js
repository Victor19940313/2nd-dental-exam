  ...
  var TOURS = {
    home: {
      ...
      steps: [
        ...
        },
        {
          s: 'a.card[href^="exam/"]',
          t: "練習本 — 主戰場",
          b: "11 年歷屆、7040 題，作者已全部分門別類。照試卷練或照單元練，每題都能標記，錯的會自動整理。",
        },
        {
    ...
    examHome: {
      ...
      steps: [
        ...
        },
        {
          s: "#hm-topic",
          t: "照單元練 — 最厲害的功能之一",
          b: "7040 題已全部分門別類。挑一個單元，把 11 年來同一個觀念的題目一次寫熟、集中火力。每個單元做過幾題、錯誤率多少一眼看到。",
        },
        {
          s: "#home-how",
          t: "作答方式",
    ...
    wrongbook: {
      ...
      steps: [
        ...
        { s: ".wb2-acc", t: "先看單元，點開才看題", b: "幾百題也不用一直滑：每個單元一行，有幾題、幾題還沒答對、一條進度條。點開才列題目，一題一行，「練」直接進那題，「移出」拿掉 🚩。" },
      ...
      steps: [
        {
          s: "#mn-tabs",
          t: "三個分頁",
          b: "「我的口訣」是你自己的，預設只有你看得到。「我的最愛」放你收藏的別人章節。「大家分享的」照科目、單元看大家公開的口訣。",
        },
        ...
        { s: "#undo-btn", t: "↶ 回復", b: "剛剛存錯了？一鍵回到上一版。" },
        {
          s: "#pub-toggle",
          t: "公開分享",
          b: "想分享給大家就打開它。一定要先選單元，複製別人的章節不能再公開。公開後別人可以按讚、收藏、留言。旁邊「已有口訣」打勾，章節標題會變綠字；黑字代表是沒口訣的重點整理。",
        },
